# Copilot instructions for pytroll/trollmoves

Purpose
- Short guide for Copilot sessions to help with builds, tests, architecture, and repository-specific conventions.
...
- No CLAUDE.md, AIDER/CONVENTIONS, AGENTS.md, .cursorrules, .clinerules, or .windsurfrules were found in the repo; add references here if you add assistant-specific rules.

When using Copilot in this repo
...
- If you want Copilot to follow project-specific coding or commit rules, add a .github/copilot-instructions.md extension or one of the recognized assistant files (e.g., CLAUDE.md) and include examples.
