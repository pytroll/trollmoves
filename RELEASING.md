...
4. run `loghub` and update the `CHANGELOG.md` file:
   ...
   ```
   loghub pytroll/trollmoves --token $LOGHUB_GITHUB_TOKEN -st v<previous version> -plg bug "Bugs fixed" -plg enhancement "Features added" -plg documentation "Documentation changes" -plg backwards-incompatibility "Backward incompatible changes" -plg refactor "Refactoring"
   ```
...
8. Create a "Release" on GitHub by going to
   https://github.com/pytroll/trollmoves/releases and clicking "Draft a new release".
